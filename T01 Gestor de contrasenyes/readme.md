...
- Paràmetres recomanats: longitud, tipus de caràcters, símbols, etc.
...
- Recomanacions per emmagatzemar aquesta còpia de manera **segura** (p. ex. clau USB xifrada o emmagatzematge xifrat al núvol).
...
Dins el **repositori del projecte-3**, heu de crear la següent estructura:
...
- Carpeta `img/` (o `pics/`): Contindrà totes les captures de pantalla utilitzades a la guia.
